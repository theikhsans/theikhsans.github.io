...
class UI {
    constructor(state) {
        ...
        this.elements = {
            ...
            sewingPatternBtn: document.getElementById('sewingPatternBtn') || document.querySelector('.view-btn[data-view="sewingPattern"]'),
            cuttingLayoutBtn: document.getElementById('cuttingLayoutBtn') || document.querySelector('.view-btn[data-view="cuttingLayout"]'),
            unitToggle: document.getElementById('unitToggle') || document.querySelector('.unit-toggle'),
            ...
            measurementContainer: document.getElementById('measurementContainer') || document.getElementById('measurementsContainer'),
    ...
    _attachEventListeners() {
        ...
        if (this.elements.sewingPatternBtn) {
            this.elements.sewingPatternBtn.addEventListener('click', () => this.state.setView('sewingPattern'));
        }
        if (this.elements.cuttingLayoutBtn) {
            this.elements.cuttingLayoutBtn.addEventListener('click', () => this.state.setView('cuttingLayout'));
        }
        ...
        this.elements.garmentSelect?.addEventListener('change', (e) => this.state.setGarment(e.target.value));
        this.elements.sizeSelect?.addEventListener('change', (e) => this.state.setSize(e.target.value));
    }
    ...
    _updateSelectStates() {
        ...
        if (this.elements.garmentButtons && this.elements.garmentButtons.length) {
            this.elements.garmentButtons.forEach(btn => {
                btn.classList.toggle('active', btn.dataset.garment === this.state.garment);
            });
        }
        ...
        if (this.elements.errorMessage) {
            if (errorCount > 0) {
                this.elements.errorMessage.textContent = 
                    `${errorCount} pengukuran di luar batas yang diizinkan`;
