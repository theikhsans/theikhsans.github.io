...
class SvgBuilder {
  ...
  static _bajuKurungCuttingLayout(m, w) {
    ...
    let svg = `<svg viewBox="0 0 ${canvasWidth} ${height + 20}" xmlns="http://www.w3.org/2000/svg">
            ...
            <text class="label" x="${x0 + 2 + m.lebar / 2}" y="${y0 + m.labuh / 2}">Badan 1</text>
  ...
  static _getLeher(m, x, y) {
    ...
    leher += `<path class="sew-line" d="M${x},${y1 + m.basi_leher} C${x + (leher6 - m.basi_leher) / 2},${y1} ${x + leher6 - m.basi_leher},${y1 + turunLeher + (turunLeher - m.basi_leher) / 2} ${x + leher6 - m.basi_leher},${y1 + turunLeher} C${x + leher6 - m.basi_leher},${y1 + turunLeher + (leher6 + turunLeher - m.basi_leher) / 2} ${x + (leher6 - m.basi_leher) / 2},${y1 + turunLeher * 2 + leher6 - m.basi_leher} ${x},${y1 + turunLeher * 2 + leher6 - m.basi_leher} C${x - (leher6 - m.basi_leher) / 2},${y1 + turunLeher * 2 + leher6 - m.basi_leher} ${x - leher6 + m.basi_leher},${y1 + turunLeher + (leher6 + turunLeher - m.basi_leher) / 2} ${x - leher6 + m.basi_leher},${y1 + turunLeher} C${x - leher6 + m.basi_leher},${y1 + (turunLeher - m.basi_leher) / 2} ${x - (leher6 - m.basi_leher) / 2},${y1 + m.basi_leher} ${x},${y1 + m.basi_leher}" />`;
    return leher;
  }
