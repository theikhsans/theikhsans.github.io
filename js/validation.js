...
const measurementRules = {
  lebar: new MeasurementRule(1, 63.5, "Lebar Bahu (A-B dan C-D)"),
  labuh: new MeasurementRule(1, 139.7, "Labuh Baju (A-D dan B-C)"),
  labuh_lengan: new MeasurementRule(1, 76.2, "Labuh Lengan (B-E)"),
  lebar_lengan: new MeasurementRule(1, 27.94, "Lebar Lengan (B-G)"),
  ...
  pesak_atas: new MeasurementRule(1, 27.94, "Pesak Atas ( G-H )"),
  pesak_bawah: new MeasurementRule(1, 27.94, "Pesak Bawah ( C-I )"),
  ...
  m_lebar: new MeasurementRule(1, 63.5, "Lebar Bahu (A-B dan C-D)"),
  m_labuh: new MeasurementRule(1, 139.7, "Labuh Baju (A-D dan B-C)"),
  m_labuh_lengan: new MeasurementRule(1, 76.2, "Labuh Lengan (B-E)"),
  m_lebar_lengan: new MeasurementRule(1, 27.94, "Lebar Lengan (B-G)"),
  m_bukaan_lengan: new MeasurementRule(1, 76.2, "Bukaan Lengan (E-F)"),
  m_lebar_kekek: new MeasurementRule(1, 17.78, "Kekek (H-J dan H-K)"),
  m_pesak_atas: new MeasurementRule(1, 27.94, "Pesak Atas ( G-H )"),
  m_pesak_bawah: new MeasurementRule(1, 27.94, "Pesak Bawah ( C-I )"),
  poket_atas: new MeasurementRule(1, 27.94, "Poket Atas"),
  poket_bawah: new MeasurementRule(1, 27.94, "Poket Bawah"),
